 ...
 * RayTracingPipeline.
 *
 * A future TODO is to allow this library to be created from multiple source files and
 * perform some form of name-based linking for global parameters and etc.
 */
class ShaderLibrary {
public:
