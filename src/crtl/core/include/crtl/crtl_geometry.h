...
CRTL_EXPORT CRTL_ERROR crtl_new_triangle_geometry(CRTLDevice device,
                                                  CRTLBufferView vertices,
                                                  CRTLBufferView indices,
                                                  CRTL_GEOMETRY_FLAG flags,
                                                  CRTLTriangleGeometry *geometry);

CRTL_EXPORT CRTL_ERROR crtl_new_renderable(CRTLDevice device,
...
CRTL_EXPORT CRTL_ERROR crtl_set_renderable_shader_record(CRTLDevice device,
                                                         CRTLRenderable renderable,
                                                         uint32_t index,
...
CRTL_EXPORT CRTL_ERROR crtl_set_group_renderable(CRTLDevice device,
                                                 CRTLGroup group,
                                                 uint32_t index,
                                                 CRTLRenderable renderable);

CRTL_EXPORT CRTL_ERROR crtl_new_instance(CRTLDevice device,
                                         CRTLGroup group,
 ...
 */
CRTL_EXPORT CRTL_ERROR crtl_set_instance_transform(CRTLDevice device,
                                                   CRTLInstance instance,
...
CRTL_EXPORT CRTL_ERROR crtl_set_scene_instance(CRTLDevice device,
                                               CRTLScene scene,
                                               uint32_t index,
                                               CRTLInstance instance);
