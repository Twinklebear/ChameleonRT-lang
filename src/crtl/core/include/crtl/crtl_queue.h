 ...
 */
CRTL_EXPORT CRTL_ERROR crtl_new_queue(CRTLDevice device, CRTLQueue *queue);
 ...
 */
CRTL_EXPORT CRTL_ERROR crtl_new_command_allocator(CRTLDevice device,
                                                  CRTLQueue queue,
 ...
 * will be invalid
 */
CRTL_EXPORT CRTL_ERROR crtl_reset_command_allocator(CRTLDevice device,
                                                    CRTLCommandAllocator cmd_allocator);

CRTL_EXPORT CRTL_ERROR crtl_new_command_buffer(CRTLDevice device,
                                               CRTLCommandAllocator cmd_allocator,
                                               CRTLCommandBuffer *cmd_buffer);

CRTL_EXPORT CRTL_ERROR crtl_close_command_buffer(CRTLDevice device,
                                                 CRTLCommandBuffer cmd_buffer);
 ...
 */
CRTL_EXPORT CRTL_ERROR crtl_submit_command_buffer(CRTLDevice device,
                                                  CRTLQueue queue,
                                                  CRTLCommandBuffer cmd_buffer,
                                                  CRTLEvent event);

CRTL_EXPORT CRTL_ERROR crtl_copy_buffer_to_buffer(CRTLDevice device,
                                                  CRTLCommandBuffer cmd_buffer,
                                                  CRTLBuffer src,
                                                  uint64_t src_offset,
                                                  CRTLBuffer dst,
...
CRTL_EXPORT CRTL_ERROR crtl_copy_buffer_to_texture(CRTLDevice device,
                                                   CRTLCommandBuffer cmd_buffer,
                                                   CRTLBuffer src,
                                                   uint64_t src_offset,
                                                   CRTLTexture dst,
...
CRTL_EXPORT CRTL_ERROR crtl_copy_texture_to_buffer(CRTLDevice device,
                                                   CRTLCommandBuffer cmd_buffer,
                                                   CRTLTexture src,
                                                   CRTLBox3D region,
                                                   CRTLBuffer dst,
 ...
 */
CRTL_EXPORT CRTL_ERROR crtl_build_blas(CRTLDevice device,
                                       CRTLCommandBuffer cmd_buffer,
                                       CRTLGroup group);

CRTL_EXPORT CRTL_ERROR crtl_update_blas(CRTLDevice device,
                                        CRTLCommandBuffer cmd_buffer,
                                        CRTLGroup group);

CRTL_EXPORT CRTL_ERROR crtl_compact_blas(CRTLDevice device,
                                         CRTLCommandBuffer cmd_buffer,
                                         CRTLGroup group);

CRTL_EXPORT CRTL_ERROR crtl_build_tlas(CRTLDevice device,
                                       CRTLCommandBuffer cmd_buffer,
                                       CRTLScene scene);

CRTL_EXPORT CRTL_ERROR crtl_update_tlas(CRTLDevice device,
                                        CRTLCommandBuffer cmd_buffer,
                                        CRTLScene scene);

CRTL_EXPORT CRTL_ERROR crtl_upload_shader_table(CRTLDevice device,
                                                CRTLCommandBuffer cmd_buffer,
                                                CRTLRTPipeline pipeline);

CRTL_EXPORT CRTL_ERROR crtl_set_rtpipeline(CRTLDevice device,
                                           CRTLCommandBuffer cmd_buffer,
                                           CRTLRTPipeline pipeline);
...
CRTL_EXPORT CRTL_ERROR crtl_dispatch_rays(CRTLDevice device,
                                          CRTLCommandBuffer cmd_buffer,
                                          uint32_t width,
                                          uint32_t height);

CRTL_EXPORT CRTL_ERROR crtl_barrier_global(CRTLDevice device,
                                           CRTLCommandBuffer cmd_buffer,
...
CRTL_EXPORT CRTL_ERROR crtl_barrier_buffer(CRTLDevice device,
                                           CRTLCommandBuffer cmd_buffer,
                                           CRTL_BARRIER_STAGE src_stages,
                                           CRTL_BARRIER_STAGE dst_stages,
                                           CRTL_BARRIER_ACCESS src_accesses,
...
CRTL_EXPORT CRTL_ERROR crtl_barrier_texture(CRTLDevice device,
                                            CRTLCommandBuffer cmd_buffer,
                                            CRTL_BARRIER_STAGE src_stages,
                                            CRTL_BARRIER_STAGE dst_stages,
                                            CRTL_BARRIER_ACCESS src_accesses,
