...
std::any RenameEntryPointParamVisitor::visit_decl_entry_point(ast::decl::EntryPoint *d)
{
...
std::any RenameEntryPointParamVisitor::visit_expr_variable(ast::expr::Variable *e)
{
