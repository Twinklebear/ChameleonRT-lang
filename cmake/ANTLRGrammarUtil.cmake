...
function(antlr_grammar_util)
    ...
    if (WIN32)
        configure_file(${ANTLR_GRAMMAR_UTIL_SCRIPT} ${CMAKE_BINARY_DIR}/${ARGV0}.ps1 @ONLY)
        add_custom_target(${ARGV0} ALL DEPENDS ${JAVA_CLASSES} ${CMAKE_BINARY_DIR}/${ARGV0}.ps1)
    else()
        configure_file(${ANTLR_GRAMMAR_UTIL_SCRIPT} ${CMAKE_BINARY_DIR}/${ARGV0}.sh @ONLY)
        add_custom_target(${ARGV0} ALL DEPENDS ${JAVA_CLASSES} ${CMAKE_BINARY_DIR}/${ARGV0}.sh)
    endif()
endfunction()
